...
public class PlaneCamera : MonoBehaviour {
    [SerializeField]
    new Camera camera;
    [SerializeField] Vector3[] cameraOffsets;
    private int currentCameraOffsetIndex = 0;
    ...
    public void ToggleCameraAngle() {
        ...
        currentCameraOffsetIndex = (currentCameraOffsetIndex + 1) % cameraOffsets.Length;
        cameraOffset = cameraOffsets[currentCameraOffsetIndex];
    }
